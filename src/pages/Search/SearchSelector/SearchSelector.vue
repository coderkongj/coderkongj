<template>
  <div class="clearfix selector">
    ...
    <div class="type-wrap" v-for="(item, index) in attrsList" :key="index">
      ...
      <div class="fl value">
        <ul class="type-list">
          <li v-for="(childItem, index) in item.attrValueList" :key="index">
            <a @click="getProps(item, childItem)">{{ childItem }}</a>
          </li>
        </ul>
      </div>
...
export default {
  ...
  methods: {
    ...
    getProps(info, childInfo) {
      this.$emit("getProps", info, childInfo);
    },
  },
};
</script>
